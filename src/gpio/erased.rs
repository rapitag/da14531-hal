...
impl<MODE> ErasedPin<MODE> {
    ...
    #[inline]
    fn block(&self) -> &crate::pac::gpio::RegisterBlock {
        ...
        let block_ptr =
            (crate::pac::GPIO::ptr() as usize + offset) as *const crate::pac::gpio::RegisterBlock;
...
impl<MODE> ErasedPin<Output<MODE>> {
    ...
    pub fn set_high(&mut self) {
        ...
        unsafe {
            self.block()
                .p0_set_data_reg
                .write(|w| w.p0_set().bits(1 << self.pin_id()))
        };
    }
    ...
    pub fn set_low(&mut self) {
        ...
        unsafe {
            self.block()
                .p0_reset_data_reg
                .write(|w| w.p0_reset().bits(1 << self.pin_id()))
        };
    }
    ...
    pub fn is_set_low(&self) -> bool {
        self.block().p0_data_reg.read().bits() & (1 << self.pin_id()) == 0
    }
